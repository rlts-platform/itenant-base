...
import {
  ...
  Users2, Zap, Settings, LogOut, Bell, Menu, DollarSign, UserCircle, Bot, ClipboardList, FilePlus, TrendingUp, CalendarClock
} from "lucide-react";
...
const clientNav = [
  ...
  { label: "Recurring Tasks", icon: CalendarClock, to: "/recurring-tasks", permission: "create_work_orders" },
